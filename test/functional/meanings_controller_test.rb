...
class MeaningsControllerTest < ActionController::TestCase
  ...
  test "should create meaning" do
    assert_difference('Meaning.count') do
      post :create, meaning: { content: @meaning.content, rating: @meaning.rating, song_id: @meaning.song_id, user_id: @meaning.user_id }
    end
  ...
  test "should update meaning" do
    put :update, id: @meaning, meaning: { content: @meaning.content, rating: @meaning.rating, song_id: @meaning.song_id, user_id: @meaning.user_id }
    assert_redirected_to meaning_path(assigns(:meaning))
  end
