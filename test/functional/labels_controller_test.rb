...
class LabelsControllerTest < ActionController::TestCase
  ...
  test "should create label" do
    assert_difference('Label.count') do
      post :create, label: { founded_date: @label.founded_date, founder: @label.founder, location: @label.location, name: @label.name }
    end
  ...
  test "should update label" do
    put :update, id: @label, label: { founded_date: @label.founded_date, founder: @label.founder, location: @label.location, name: @label.name }
    assert_redirected_to label_path(assigns(:label))
  end
